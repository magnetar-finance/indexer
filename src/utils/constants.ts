...
const LITVM_TESTNET = 'liteforge';
const NEURA_TESTNET = 'neura-testnet';
...
ORACLES.set(LITVM_TESTNET, '0x46e65AfC0BBF7cc037D82AC2eA9aaf560dD962Cc');
ORACLES.set(NEURA_TESTNET, '0x3562cceE39adc7465f1bAed088043C5C5B41e4e6');
...
WETH.set(LITVM_TESTNET, '0xeb29947d9c1cd59af2b413b47505bf89a47be0d4');
WETH.set(NEURA_TESTNET, '0x422F5Eae5fEE0227FB31F149E690a73C4aD02dB8');
